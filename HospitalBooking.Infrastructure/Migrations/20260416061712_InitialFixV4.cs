...
{
    /// <inheritdoc />
    public partial class InitialFixV4 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MaxTokensOnline = table.Column<int>(type: "int", nullable: false),
                    MaxTokensWalkIn = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SlotBlocks_Doctors_DoctorId",
                        column: x => x.DoctorId,
                        principalTable: "Doctors",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TestsAdvised = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Appointments_DoctorId_AppointmentDate_TokenNumber",
                table: "Appointments",
                columns: new[] { "DoctorId", "AppointmentDate", "TokenNumber" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SlotBlocks_DoctorId",
                table: "SlotBlocks",
                column: "DoctorId");

            migrationBuilder.CreateIndex(
                name: "IX_TokenLocks_DoctorId_AppointmentDate_TokenNumber",
                table: "TokenLocks",
                columns: new[] { "DoctorId", "AppointmentDate", "TokenNumber" });
        }
